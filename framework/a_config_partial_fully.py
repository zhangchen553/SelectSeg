...
save_folder = '/Results_' + DATASET + '/partial_fully_supervise/'
...
sup_portion = 60
partial_type = ''  # '_f1_base' '_mse_base' ''_f1_f1_var '_f1_base'

if DATASET == 'CRACK500':
    DATA_PATH = STORAGE_PATH + '/DATASET/CRACK500'
    TRAIN_IMG_PATH = DATA_PATH + '/train_crop_image/'
    TRAIN_MASK_PATH = DATA_PATH + '/train_crop_mask_50pct/'
